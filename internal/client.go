...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/zhiyin2021/rocketmq-client-go/internal  --package internal RMQClient

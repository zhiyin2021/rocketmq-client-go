...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/zhiyin2021/rocketmq-client-go/consumer  --package consumer OffsetStore
